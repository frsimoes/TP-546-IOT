...
URL_da_requisicao = 'https://api.telegram.org/bot' + credenciais.bot_token +'/getUpdates'
 
URL_de_envio = 'https://api.telegram.org/bot' + credenciais.bot_token +'/sendMessage'
